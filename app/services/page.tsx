...
// Add this key to your en.json and ar.json inside the "servicesPage" object:
// "cardDesc": "..."
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {serviceTitles.map((title, index) => (
            <Link key={index} href={serviceLinks[index]} className="bg-white text-black rounded-3xl p-10 shadow-2xl hover:-translate-y-3 hover:shadow-green-500/20 transition duration-300">
              ...
              <p className="text-gray-600 leading-loose mb-6">{t("servicesPage.cardDesc")}</p>
