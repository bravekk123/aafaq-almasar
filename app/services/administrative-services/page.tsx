...
export default function AdministrativeServicesPage() {
  ...
  const sectors = [
    isArabic ? "المكاتب القانونية" : "Legal Offices",
    isArabic ? "الخدمات المهنية" : "Professional Services",
    isArabic ? "القطاع الحكومي" : "Government Sector",
    isArabic ? "التعليم" : "Education",
    isArabic ? "المرافق العامة" : "Public Utilities",
  ];
