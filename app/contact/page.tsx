          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 rounded-3xl p-10 shadow-xl">
              ...
              <div className="space-y-4 mt-6">
                <a href="mailto:info@aafaqalmasar.ae" className="block text-green-700 font-bold break-words hover:underline">
                  info@aafaqalmasar.ae
                </a>
              </div>
            </div>
            ...
            <div className="bg-gray-100 rounded-3xl p-10 shadow-xl">
              ...
              <p className="text-gray-700 leading-loose">
                Commercial License No: 1415606
                <br />
                Dubai Mainland Company
                <br />
                Aafaq Almasar Project Management Services L.L.C.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-black">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-[40px] p-12 text-black shadow-2xl">
            <form action="https://formsubmit.co/info@aafaqalmasar.ae" method="POST" className="space-y-8">
